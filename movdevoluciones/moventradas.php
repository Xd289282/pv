<?php
	...
	$_SESSION["pvtacommand_nivelm_sub"]=19; // opcion activa de menu
...
<body>	
						...
						<div class="rrow scroll-y" id="mainYScroller">
							<div class="inner topRight">
								...
								<div class="heading-buttons">
									<h2 class="glyphicons home"><i></i>Devoluciones de Productos</h2>
									<div class="buttons pull-right">
										<a href="#" onclick="accionese(1,0)" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Agregar Devolución</a>
									</div>
								</div>
								<div class="separator"></div>
								<div class="row-fluid">
									<div class="span9">
										<div class="widget widget-2">
											<?php include "moventrada_listar.php";?>	
										</div>
									</div>
									<?php include "movimientos_filtro.php";?>
								</div>
							<br />
							</div>
						</div>
	...
	<script src="entradas_js.js" type="text/javascript"></script>
</body>
</html>