...
//numero de productos
$noproductos=0;
$consulta="select sum(cantidad) as noproductos  from tmpbajas where idsesion='$idsesion' and idunicoe='$idunicoe' ";
...
$consulta="select a.cantidad,b.pmostrador,b.iva,b.descuento from tmpbajas as a left join productos as b on a.idunicoe=b.idunicoe and a.idunicop=b.idunicop where a.idsesion='$idsesion' and a.idunicoe='$idunicoe'";
$recordset = mysqli_query($link,$consulta);
