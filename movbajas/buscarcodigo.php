...
if($existearticulo>0){
	...
	if($existearticulo>1){// existen varias entradas del mismo articulo en el inventario
		...
		$consulta="select sum(cantidad) as cantidad from tmpbajas where idunicoe='$idunicoe' and idunicop='$idunicop' and idunicos='$idunicos'";
		$recordset = mysqli_query($link,$consulta);
...
if($existearticulo>0){//si existe agregarlo a la venta
	...
	$existe=0;
	$consulta="select count(*) as no from tmpbajas where idsesion='$idsesion' and idunicoe='$idunicoe' and idunicop='$idunicop' and idunicos='$idunicos'";
	$recordset = mysqli_query($link,$consulta);
	...
	if($existe==0){
		$idunicoregi=0;
		$consulta="select idunicoregi from inventario where idunicoe='$idunicoe' and idunicop='$idunicop' and idunicos='$idunicos' and tipo='0'";
		$recordset = mysqli_query($link,$consulta);
		...
		$consulta="update tmpbajas set cantidad=cantidad+'$cantidad' where idsesion='$idsesion' and idunicoe='$idunicoe' and idunicop='$idunicop'";
		mysqli_query($link,$consulta);
	}
