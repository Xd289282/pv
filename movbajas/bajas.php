<?php
	...
	$_SESSION["pvtacommand_nivelm_sub"]=7; // opcion activa de menu
						...
						<div class="filter-bar">
							<form />
								...
								<div>											
									...
									<div class="input-append">										
										<button class="btn btn-primary btn-large btn-icon glyphicons print" id="generabaja"><i></i>Generar Baja</button>
									</div>
								</div>
