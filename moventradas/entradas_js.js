$.validator.setDefaults(
{
	...
	function acciones_sql(){	
		...
		var id=0;
		$("#invtallas").find(':input').each(function() {
         var elemento= this;
		...
		$.post("entradas_sql.php",{id:id,idu:idu,codigo:codigo,fechae:fechae,cantidad:cantidad,pcompra:pcompra,folio:folio,pmostrador:pmostrador,opcion:opcion,modelo:modelo,talla:talla,lote:lote,fcaducidad:fcaducidad,arreglo:arreglo},function(resultado){
			//alert(resultado);
...
function abrirbusqueda(){
	...
	function buscarcodigo(codigo){
		...
		$.post("buscarcodigo.php",{codigo:codigo},function(resultado){	
