...
if($opcion==2 || $opcion==3){ // mostrar valores
	$consulta="select * from entradas left join productos on entradas.idunicop=productos.idunicop left join inventario on entradas.idunicoregi=inventario.idunicoregi where entradas.idunicoreg='$id'";
	...
	while($registro = mysqli_fetch_array($recordset)){
	    ...
	    if(!isset($registro["fcaducidad"])){$fcaducidad="";
		}else{
	    ...
	    if(!isset($registro["color"])){$color="";}else{$color=trim($registro["marca"]);}
...
?>	
				...
				<form class="form-horizontal" style="padding-top: 10px; margin-bottom: 0;" id="validaempresa" method="post" action="" autocomplete="off" />	
					...
					<div class="span8">
						<div class="well" style="padding-bottom: 10px;">
							<h4>Datos de la Entrada <?php echo $mensajetit;?></h4>
	...
	<div class="controls"><input class="span12" id="modelo" name="modelo" type="text" maxlength="50" value="<?php echo $modelo;?>"  /></div>
							...
							<div class="span6">
								...
								<div class="control-group">
										<label class="control-label" for="nombre">Fecha de Entrada:</label>
	   							     <div class="controls">
                                          <div class="input-append">
	   							                <input type="text"  id="datepicker" class="span12" value="<?php echo $fecha;?>" />
												<span class="add-on glyphicons calendar"><i></i></span>
								          </div>
								    </div>	
...
<!-- 								<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label" for="nombre">Folio:</label>
									<div class="controls"><input class="span12" id="folio" name="folio" type="text" maxlength="10" value="<?php echo $folio;?>"  /></div>
								</div>	

								<div id="invtallas" style="overflow:scroll;height:300px;">
