						...
						<div class="rrow scroll-y" id="mainYScroller">
							<div class="inner topRight">
								...
								<div class="heading-buttons">
									<h2 class="glyphicons home"><i></i>Entradas de Productos</h2>
									<div class="buttons pull-right">
										<a href="#" onclick="accionese(1,0)" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Agregar Entrada</a>
									</div>
								</div>
								<div class="separator"></div>
								<div class="row-fluid">
