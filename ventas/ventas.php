...
<head>
	...
	<style>
		.modal.ventana1 { width:900px; height:500px; }
						...
						<div class="filter-bar">
							<form />
								...
								<div>											
									...
									<div class="input-append">										
										<button class="btn btn-primary btn-large btn-icon glyphicons print" id="ventana2"><i></i>Generar Pago</button>
									</div>
								</div>
