$.validator.setDefaults(
{
	...
	var opcion=$("#opcion").val();
		...
		$.post("inventario_sql.php",{id:id,codigo:codigo,cantidad:cantidad,opcion:opcion,modelo:modelo,talla:talla,lote:lote,fcaducidad:fcaducidad},function(resultado){
			...
			$(location).attr('href','inventarios.php');
