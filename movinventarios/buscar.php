...
<body>
	...
	<div class="row-fluid rrow ">
		<div class="span12 main col" role="main">
		    <div class="row-fluid rrow" style="overflow:scroll; height:100%;"><!--ampliar ventana de busqueda-->
										...
										<div class="tab-pane active" id="account-details">											
											<div class="widget widget-2">
												<div class="widget-head">
													<h4 class="heading glyphicons edit"><i></i>Listado de Productos</h4>
												</div>
	...
	function filtradoproductos(){
		...
		$.post("listaproductos.php",{describusca:describusca,agrupador:agrupador},function(resultado){			
