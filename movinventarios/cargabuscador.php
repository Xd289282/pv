...
//datos del producto
$consulta="select * from productos where idunicop='$idunicop' and idunicoe='$idunicoe' and tipo='0'";
$recordset = mysqli_query($link,$consulta);
while($registro = mysqli_fetch_array($recordset)){
...
// inventario
$consulta="select * from inventario where idunicoregi='$idunicoregi' and idunicoe='$idunicoe' and idunicop='$idunicop' and tipo='0'";
$recordset = mysqli_query($link,$consulta);
while($registro = mysqli_fetch_array($recordset)){
	$cantidad=$registro["cantidad"];
	$modelo=trim($registro["modelo"]);
	$talla=trim($registro["talla"]);
	$lote=trim($registro["lote"]);
