		...
		<tbody>
			...
			if($agrupador==0){	
				...
				$consulta="select c.idunicoregi,a.idunicop,a.codigo,a.nombrep,a.pmostrador,a.iva,a.marca,a.color,c.modelo,c.talla,c.lote,c.cantidad,a.descuento,a.serie,c.fcaducidad
					from productos as a left join detprodagrup as b on a.idunicop=b.idunicop and a.idunicoe=b.idunicoe left join inventario as c on a.idunicop=c.idunicop where a.idunicoe='$idunicoe' and c.idunicos='$idunicos' and b.idunicoa in $cadagru and a.nombrep like '%".$describusca."%' and a.tipo='0'";
			}
			$cons=$consulta;
			$fila=1;
			$recordset = mysqli_query($link,$consulta);
