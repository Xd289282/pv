...
?>
    ...
    <div class="widget-body list list-2">
        <ul>
            <li class="active"><a href="#" class="glyphicons link" onClick="repentradas();"><i></i>Procesar Reporte</a></li>
<!--													<li><a href="" class="glyphicons link"><i></i>Show inactive products</a></li>-->
  ...
  function repentradas(){//generacion de reporte de entradas
    ...
    window.open("../reportes/entradas2.php?fecha1="+fechaini+"&fecha2="+fechafin+"&id="+id+"&modelo="+modelo+"&talla="+talla+"&lote="+lote);
    jAlert('Reporte de Entrada Generado', 'Atención!!');
