...
left join productos as c on b.idunicop=c.idunicop left join catusuarios as d on a.idunicou=d.idunicou where a.fecha>='$fechai' and a.fecha<='$fechaf' and a.tiposal=0 and a.idunicoe='$idunicoe' and a.idunicos='$idunicos'";
...
$html1='<table border="0" align="center">          
 ...
 <tr>
	...
	<td class="tds1" width="60%"align="center"><font style="font-size:40px" face="Arial, Helvetica, sans-serif" ><strong><br>SISTEMA DE PUNTO DE VENTA <BR> '.$nombreempresa.'<br>Reporte de Salidas x Ventas</strong></font>
   </td>
...
$html3='<table border="1" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <th width="30%" align="center"><strong>Producto</strong></th>
    ...
    while($registro = mysqli_fetch_array($recordset)){
		...
		$pfinal=$registro["pfinal"];
			...
			$fila1=$fila1.'    <tr bgcolor="#CCCCCC" bordercolor="#FFFFFF">
				...
				<td  width="20%" height="20" align="justify" ><font face="Arial, Helvetica, sans-serif"size="8">'.$codigo.'</font></td>
				<td  width="30%" height="20" align="justify" ><font face="Arial, Helvetica, sans-serif"size="8">'.$nombrep.'</font></td>
