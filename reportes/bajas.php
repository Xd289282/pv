...
left join productos as c on b.idunicop=c.idunicop left join catusuarios as d on a.idunicou=d.idunicou where a.fecha>='$fechai' and a.fecha<='$fechaf' and a.tiposal=2 and a.idunicoe='$idunicoe' and a.idunicos='$idunicos'";
...
$html1='<table border="0" align="center">          
 ...
 <tr>
	...
	<td class="tds1" width="60%"align="center"><font style="font-size:40px" face="Arial, Helvetica, sans-serif" ><strong><br>SISTEMA DE PUNTO DE VENTA <BR> '.$nombreempresa.'<br>Reporte de Salidas x Bajas</strong></font>
   </td>
