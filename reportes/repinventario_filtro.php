        ...
        <ul>
          ...
          <?php
            ...
            <li>
                <label>Tipo:</label>
                <div class="right">
                <div class="controls"><input class="span12" id="tipo" name="tipo" type="text" maxlength="50" value=""  /></div>
                </div>
            </li>   
...
<!--                          <li><a href="" class="glyphicons link"><i></i>Show inactive products</a></li>-->
  ...
  function repinventario(){//generacion de reporte de entradas
    ...
    window.open("../reportes/inventario.php?id="+id+"&modelo="+modelo+"&talla="+talla+"&lote="+lote+"&tipo="+tipo);
