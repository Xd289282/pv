<?php
	...
	$_SESSION["pvtacommand_nivelm_sub"]=3; // opcion activa de menu
						...
						<div class="rrow scroll-y" id="mainYScroller">
							<div class="inner topRight">
								...
								<div class="heading-buttons">
									<h2 class="glyphicons home"><i></i>Productos</h2>
									<div class="buttons pull-right">
										<a href="#" onclick="acciones(1,0)" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Agregar Producto</a>
									</div>
								</div>
								<div class="separator"></div>
								<div class="row-fluid">
									<div class="span9">
										<div class="widget widget-2">
											<?php include "../catalogos_listar/productos_listar.php";?>	
										</div>
									</div>
<!-- 									<?php include "../catalogos_filtro/empresa_filtro.php";?>
 -->								</div>
	...
	<script src="../catalogos_js/productos_js.js" type="text/javascript"></script>
</body>
</html>