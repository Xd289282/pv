<?php
	...
	$_SESSION["pvtacommand_nivelm"]=2;
	$_SESSION["pvtacommand_nivelm_sub"]=15;
?>
<!DOCTYPE html>
<html> 
<head>
						...
						<div class="rrow scroll-y" id="mainYScroller">
							<div class="inner topRight">
								...
								<div class="heading-buttons">
									<h2 class="glyphicons airplane"><i></i>Tipos de Producto</h2>
									<div class="buttons pull-right">
										<a href="#" onclick="acciones(1,0)" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Agregar Tipo de Producto</a>
									</div>
								</div>
								<div class="separator"></div>
								<div class="row-fluid">
									<div class="span9">
										<div class="widget widget-2">
											<?php include "../catalogos_listar/tipoprod_listar.php";?>	
										</div>
									</div>
<!-- 									<?php include "../catalogos_filtro/tipoprod_filtro.php";?>
 -->								</div>
							<br />
							</div>
						</div>
	...
	<script src="../catalogos_js/tipoprod_js.js" type="text/javascript"></script>
</body>
</html>