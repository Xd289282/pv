<?php
	...
	$_SESSION["pvtacommand_nivelm_sub"]=18; // opcion activa de menu
?>
<!DOCTYPE html>
<html> 
<head>
							...
							<div class="inner topRight">
								...
								<div class="heading-buttons">
									...
									<div class="buttons pull-right">
										<a href="#" onclick="acciones(1,0)" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Agregar Usuario</a>
									</div>
								</div>
								<div class="separator"></div>
								<div class="row-fluid">
									<div class="span9">
										<div class="widget widget-2">
											<?php include "../catalogos_listar/usuarios_listar.php";?>	
										</div>
									</div>
