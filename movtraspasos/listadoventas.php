...
<table id="example" class="display table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable" cellspacing="0" width="100%">
		...
		<tbody>
			...
			$consulta="select a.idunicop,b.codigo,b.nombrep,a.cantidad,b.pmostrador,b.iva,b.descuento,b.marca,b.color,b.serie,a.idunicoregi from tmptraspaso as a left join productos as b on a.idunicop=b.idunicop where a.idsesion='$idsesion' and a.idunicoe='$idunicoe'";
			$recordset = mysqli_query($link,$consulta);
			while($registro = mysqli_fetch_array($recordset)){				
