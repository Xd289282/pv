...
$existe=0;
$consulta="select count(*) as no from tmptraspaso where idsesion='$idsesion' and idunicoe='$idunicoe' and idunicop='$idunicop' and idunicoregi='$idunicoregi'";
...
if($existe==0){
	...
	$consulta="update tmptraspaso set cantidad=cantidad+'$cantidad' where idsesion='$idsesion' and idunicoe='$idunicoe' and idunicop='$idunicop' and idunicoregi='$idunicoregi'";
	mysqli_query($link,$consulta);
}
?>