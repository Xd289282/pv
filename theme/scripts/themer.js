...
function themerGetCode(less)
{
	...
	var videobox = bootbox.dialog('<iframe width="800" height="800" src="http://localhost/tiendavirtual3/" frameborder="0" allowfullscreen></iframe>', {
...
$(function()
{
	if ($('#themer').length)
	{
		...
		$('#busqueda2').click(function(e){
			
			e.preventDefault();
			//themerGetCode();
			var videobox = bootbox.dialog('<iframe width="800" height="800" src="http://localhost/sedeco/" frameborder="0" allowfullscreen></iframe>', {
