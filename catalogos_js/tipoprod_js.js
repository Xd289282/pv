...
function acciones_sql(){
	...
	$.post("../catalogos_sql/tipoprod_sql.php",{cvetip:cvetip,descripcion:descripcion,opcion:opcion},function(resultado){  
					//alert(resultado);
		...
		$(location).attr('href','../catalogos/tipoprod.php');
...
function acciones(opcion,id){ // 1 agregar 2 modificar 3 eliminar
	...
	$.post("../catalogos_sql/opciones.php",{id:id,opcion:opcion},function(resultado){  
		...
		$(location).attr('href','../catalogos_add/tipoprod_add.php'); 	
...
$(function()
{
	...
	$("#validaproveedores").validate({
		...
		messages: {
			descripcion: "Porfavor agregue la descripcion",
		}
	});
