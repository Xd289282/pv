...
function acciones_sql(){
	...
	$.post("../catalogos_sql/proveedores_sql.php",{nombre:nombre,opcion:opcion},function(resultado){  
		...
		$(location).attr('href','../catalogos/proveedores.php');
...
function acciones(opcion,id){ // 1 agregar 2 modificar 3 eliminar
	...
	$.post("../catalogos_sql/opciones.php",{id:id,opcion:opcion},function(resultado){  
		...
		$(location).attr('href','../catalogos_add/proveedores_add.php'); 	
...
$(function()
{
	...
	$("#validaproveedores").validate({
		...
		messages: {
			nombre: "Porfavor agregue el nombre del Proveedor",
		}
	});
