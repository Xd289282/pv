...
function acciones_sql(){
	...
	$.post("../catalogos_sql/sucursales_sql.php",{empresa:empresa,nombre:nombre,calle:calle,estado:estado,telefono:telefono,rfc:rfc,colonia:colonia,municipio:municipio,opcion:opcion},function(resultado){  
		...
		$(location).attr('href','../catalogos/sucursales.php');
...
function acciones(opcion,id){ // 1 agregar 2 modificar 3 eliminar
	...
	$.post("../catalogos_sql/opciones.php",{id:id,opcion:opcion},function(resultado){  
		...
		$(location).attr('href','../catalogos_add/sucursales_add.php'); 	
