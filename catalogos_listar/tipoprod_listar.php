...
<div class="widget-head">
	<h4 class="heading glyphicons list"><i></i>Administración de Tipos de Producto</h4>
</div>
<div class="widget-body">
	...
	<table id="example" class="display table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable" cellspacing="0" width="100%">
		<thead>
			<tr>				
				<th width="1%" class="center">Clave</th>
				<th>Descripcion</th>
		...
		<tbody>
	        ...
	        while($registro = mysqli_fetch_array($recordset)){
				...
				echo'<tr class="selectable">';
					echo'<td class="center">'.$cvetip.'</td>';
					echo'<td><strong>'.$descripcion.'</strong></td>';
					echo'
						<td class="center">
							<a href="#" onClick="acciones(2,'.$cvetip.');" title="modificar" class="btn-action glyphicons pencil btn-success"><i></i></a>
							<a href="#" onClick="acciones(3,'.$cvetip.');" title="eliminar" class="btn-action glyphicons remove_2 btn-danger"><i></i></a>
						</td>';
				echo'</tr>';
